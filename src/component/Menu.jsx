    ...
    return (
        <Fragment>
            <div style={{ width:"100%",height: 45, marginTop: 5, overflowY: "hidden" }}>
                ...
                <Zoom style={{ position: "absolute", width: 40, height: 40, zIndex: 2, textAlign: "center",right:0 }} in={props.contentType === "list"} onClick={() => { props.setContentType("swipe"); }}><div style={{ fontSize: 10, top: 62 }}><SwapHoriz fontSize="small" /></div></Zoom>
                <Zoom style={{ position: "absolute", width: 40, height: 40, zIndex: 2, textAlign: "center",right:0 }} in={props.contentType === "swipe"} onClick={() => { props.setContentType("list"); }}><div style={{ fontSize: 10, top: 62 }}><Search fontSize="small" /></div></Zoom>
